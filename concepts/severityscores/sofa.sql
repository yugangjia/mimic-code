...
--  6) echodata - generated by echo-data.sql//not available in MIMIC-IV, so will ignore this part
...
--, echo2 as(
--  select ie.stay_id, avg(weight * 0.45359237) as weight
...
(
  ...
  from `vvs-marketscan.yugang_dev.blood_gas_first_day_arterial` bg
  left join `vvs-marketscan.yugang_dev.ventilator_durations` vd
...
left join `vvs-marketscan.yugang_dev.vitals_first_day` v
  on ie.stay_id = v.stay_id
left join `vvs-marketscan.yugang_dev.labs_first_day` l
